...
// pgIntersection_*'s three final parameters are pointers to X, optional, Y, optional, T, optional.
...
static int
pgIntersection_LineLine(pgLineBase *, pgLineBase *, double *, double *, double *);
static int
...
static int
pgIntersection_LineCircle(pgLineBase *, pgCircleBase *, double *, double *, double *);
static int
